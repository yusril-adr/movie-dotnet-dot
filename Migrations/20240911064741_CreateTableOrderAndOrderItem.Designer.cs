...
namespace dot_dotnet_test_api.Migrations
{
    ...
    [Migration("20240911064741_CreateTableOrderAndOrderItem")]
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.MovieV1", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 9981L,
                            CreatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6270),
                            Overview = "When Tony Stark tries to jumpstart a dormant peacekeeping program, things go awry and Earth’s Mightiest Heroes are put to the ultimate test as the fate of the planet hangs in the balance. As the villainous Ultron emerges, it is up to The Avengers to stop him from enacting his terrible plans, and soon uneasy alliances and unexpected action pave the way for an epic and unique global adventure.",
                            PlayUntil = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6260),
                            Poster = "https://image.tmdb.org/t/p/original/4ssDuvEDkSArWEdyBl2X5EHvYKU.jpg",
                            Title = "Avengers: Age of Ultron",
                            UpdatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6270)
                        });
                });
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.StudioV1", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6310),
                            SeatCapacity = 50,
                            StudioNumber = 1,
                            UpdatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6320)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6320),
                            SeatCapacity = 50,
                            StudioNumber = 2,
                            UpdatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6320)
                        },
                        new
                        {
                            ...
                            SeatCapacity = 50,
                            StudioNumber = 3,
                            UpdatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6330)
                        },
                        new
                        {
                            Id = 4L,
                            CreatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6330),
                            SeatCapacity = 50,
                            StudioNumber = 4,
                            UpdatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6330)
                        });
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.TagV1", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6200),
                            Name = "Action",
                            UpdatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6210)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6250),
                            Name = "Comedy",
                            UpdatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 989, DateTimeKind.Local).AddTicks(6250)
                        },
                        new
                        {
                            Id = 3L,
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.UserV1", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 979, DateTimeKind.Local).AddTicks(7330),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "user@getnada.com",
                            Is_admin = false,
                            Name = "user test",
                            Password = "XSU3HSdVAgQXEaIJL7a/12us1N6r21gVkhNeuo/zK0rtT/H2rQC8l5Hte713OA1r",
                            UpdatedAt = new DateTime(2024, 9, 11, 13, 47, 40, 979, DateTimeKind.Local).AddTicks(7370)
                        });
                });

...
namespace dot_dotnet_test_api.Migrations
{
    ...
    [Migration("20240913030235_AlterTableNameStudioAndOrder")]
    partial class AlterTableNameStudioAndOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.MovieV1", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 9981L,
                            CreatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2440),
                            Overview = "When Tony Stark tries to jumpstart a dormant peacekeeping program, things go awry and Earth’s Mightiest Heroes are put to the ultimate test as the fate of the planet hangs in the balance. As the villainous Ultron emerges, it is up to The Avengers to stop him from enacting his terrible plans, and soon uneasy alliances and unexpected action pave the way for an epic and unique global adventure.",
                            PlayUntil = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2430),
                            Poster = "https://image.tmdb.org/t/p/original/4ssDuvEDkSArWEdyBl2X5EHvYKU.jpg",
                            Title = "Avengers: Age of Ultron",
                            UpdatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2440)
                        });
                });
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.Studio", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2480),
                            SeatCapacity = 50,
                            StudioNumber = 1,
                            UpdatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2490)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2490),
                            SeatCapacity = 50,
                            StudioNumber = 2,
                            UpdatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2490)
                        },
                        new
                        {
                            ...
                            SeatCapacity = 50,
                            StudioNumber = 3,
                            UpdatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2500)
                        },
                        new
                        {
                            Id = 4L,
                            CreatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2500),
                            SeatCapacity = 50,
                            StudioNumber = 4,
                            UpdatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2500)
                        });
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.TagV1", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2380),
                            Name = "Action",
                            UpdatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2380)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2420),
                            Name = "Comedy",
                            UpdatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 381, DateTimeKind.Local).AddTicks(2420)
                        },
                        new
                        {
                            Id = 3L,
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 371, DateTimeKind.Local).AddTicks(2450),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "user@getnada.com",
                            Is_admin = false,
                            Name = "user test",
                            Password = "Ff3b8dXuQGi4w5XY0glXb2i82Ghxrc6KwyPZ4/YoM9pO7hWV/2m+IZZol1BKGaTR",
                            UpdatedAt = new DateTime(2024, 9, 13, 10, 2, 34, 371, DateTimeKind.Local).AddTicks(2520)
                        });
                });

...
namespace dot_dotnet_test_api.Migrations
{
    ...
    [Migration("20240912100144_RenameTableUsers")]
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.MovieV1", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 9981L,
                            CreatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(5000),
                            Overview = "When Tony Stark tries to jumpstart a dormant peacekeeping program, things go awry and Earth’s Mightiest Heroes are put to the ultimate test as the fate of the planet hangs in the balance. As the villainous Ultron emerges, it is up to The Avengers to stop him from enacting his terrible plans, and soon uneasy alliances and unexpected action pave the way for an epic and unique global adventure.",
                            PlayUntil = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(4990),
                            Poster = "https://image.tmdb.org/t/p/original/4ssDuvEDkSArWEdyBl2X5EHvYKU.jpg",
                            Title = "Avengers: Age of Ultron",
                            UpdatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(5000)
                        });
                });
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.StudioV1", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(5050),
                            SeatCapacity = 50,
                            StudioNumber = 1,
                            UpdatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(5050)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(5060),
                            SeatCapacity = 50,
                            StudioNumber = 2,
                            UpdatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(5060)
                        },
                        new
                        {
                            Id = 3L,
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.TagV1", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(4890),
                            Name = "Action",
                            UpdatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(4900)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(4980),
                            Name = "Comedy",
                            UpdatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 686, DateTimeKind.Local).AddTicks(4980)
                        },
                        new
                        {
                            Id = 3L,
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 676, DateTimeKind.Local).AddTicks(5850),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "user@getnada.com",
                            Is_admin = false,
                            Name = "user test",
                            Password = "zADSZixXx18SrD3L+kyTPThWXaZpGqYvdREzqWXkMl/kwodUPUoCSpg/9FMa9TCP",
                            UpdatedAt = new DateTime(2024, 9, 12, 17, 1, 43, 676, DateTimeKind.Local).AddTicks(5970)
                        });
                });

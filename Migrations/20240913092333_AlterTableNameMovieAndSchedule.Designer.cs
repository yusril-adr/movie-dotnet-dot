...
namespace dot_dotnet_test_api.Migrations
{
    ...
    [Migration("20240913092333_AlterTableNameMovieAndSchedule")]
    partial class AlterTableNameMovieAndSchedule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 9981L,
                            CreatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7430),
                            Overview = "When Tony Stark tries to jumpstart a dormant peacekeeping program, things go awry and Earth’s Mightiest Heroes are put to the ultimate test as the fate of the planet hangs in the balance. As the villainous Ultron emerges, it is up to The Avengers to stop him from enacting his terrible plans, and soon uneasy alliances and unexpected action pave the way for an epic and unique global adventure.",
                            PlayUntil = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7430),
                            Poster = "https://image.tmdb.org/t/p/original/4ssDuvEDkSArWEdyBl2X5EHvYKU.jpg",
                            Title = "Avengers: Age of Ultron",
                            UpdatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7430)
                        });
                });
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.Studio", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7480),
                            SeatCapacity = 50,
                            StudioNumber = 1,
                            UpdatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7480)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7490),
                            SeatCapacity = 50,
                            StudioNumber = 2,
                            UpdatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7490)
                        },
                        new
                        {
                            Id = 3L,
                        ...
                        {
                            Id = 4L,
                            CreatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7500),
                            SeatCapacity = 50,
                            StudioNumber = 4,
                            UpdatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7500)
                        });
                });
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7370),
                            Name = "Action",
                            UpdatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7370)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7410),
                            Name = "Comedy",
                            UpdatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7420)
                        },
                        new
                        {
                            Id = 3L,
                            CreatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7420),
                            Name = "Fantasy",
                            UpdatedAt = new DateTime(2024, 9, 13, 16, 23, 33, 1, DateTimeKind.Local).AddTicks(7420)
                        });
                });
            ...
            modelBuilder.Entity("dot_dotnet_test_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 13, 16, 23, 32, 991, DateTimeKind.Local).AddTicks(9140),
                            DeletedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "user@getnada.com",
                            Is_admin = false,
                            Name = "user test",
                            Password = "WfTARYfPaGkxiuUSOEjpwt3SmGzib72HHccyfhAp1IbkCGwDsuRyQ/RXLCxeYvXS",
                            UpdatedAt = new DateTime(2024, 9, 13, 16, 23, 32, 991, DateTimeKind.Local).AddTicks(9180)
                        });
                });
